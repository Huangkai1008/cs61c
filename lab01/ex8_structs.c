...
int main() {
    // declare a variable student1 of type struct Student
    // Note: this struct is stored on the stack
    struct Student student1;

    // set student1's id field to 5
    // Hint: the dot notation accesses a struct's fields
    student1.id = 5;

    // print out student1's id field
    printf("Student 1's ID: %d\n", student1.id);

    // You can also store a struct on the heap

    // allocate memory to store a struct Student on the heap
    ...
    // set student2_ptr's id field to 6
    ...
    // print out student2_ptr's id field
